...
# from flight_price.components.model_pusher import ModelPusher


from flight_price.entity.config_entity import*
                                        # (DataIngestionConfig,
...
from flight_price.entity.artifact_entity import*
